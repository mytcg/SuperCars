				...
				this.run=function(){
					...
					if(this.$.is("fieldset")){
						...
						this.i.each(function(t){
							var r=e(this);n.i[t]=r;n.v[t]=n.o.parse(r.val());
					...
					if(this.v instanceof Object){
						...
						this.cv=this.v}this.$.bind("configure",t).parent().bind("configure",t);this._listen()._configure()._xy().init();
						this.isInit=true;
						...
						this._carve=function(){
							...
							if(this.relative){
								...
								this.w=this.o.width;this.h=this.o.height}this.$div.css({
									width:this.w+"px",
									height:this.h+"px"
								});
							this.$c.attr({
						...
						this._draw=function(){
							...
							this._mouse=function(e){
								var r=function(e){
									...
									if(t==n.cv)return;if(n.cH&&n.cH(t)===false)return;
